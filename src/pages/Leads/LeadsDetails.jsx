  ...
  return (
    <div className="overflow-auto mb-3 no-scrollbar" >
      <div className="flex justify-between my-3 ">
        ...
        <button className="font-Source_Sans_Pro font-normal bg-orange rounded-md text-white px-8 py-2">
          Add FollowUp
        </button>
      </div>
      <div className="grid grid-cols-2 gap-6 my-5  ">
        <div className="bg-[#7ABDFF33] rounded-xl shadow-lg ">
          ...
          <div className=" bg-white flex justify-between items-center pb-16 rounded-b-lg">
            ...
            <p className=" relative top-12 ml-6 text-[#7D7D7D] font-semibold text-base">Profile name</p>
            <p className="relative top-12 ml-6 text-[#D1D1D1] text-base font-normal">00000 00000</p>
            </div>
        ...
        <div className=" font-Source_Sans_Pro text-sm font-semibold text-[#2C3E50] bg-white rounded-xl shadow-lg pl-8 pt-8 ">
          <h1 className="mb-8 text-base text-[#2C3E50]">Basic Information</h1>
          <h1 className="flex gap-4 mb-2">
            Complaint Raised from:
            <span className="pl-16 text-[#7D7D7D]">Call</span>
          </h1>
          <h1 className="flex gap-7  mb-2">
            Created At:
            <span className="pl-32 text-[#7D7D7D]"> 27/09/2024 10:00 am</span>
          </h1>
          <h1 className="flex gap-2 mb-2">
            Email:
            <span className="pl-44 text-[#7D7D7D]"> ravikumar@gmail.com </span>
          </h1>
          <h1 className="flex gap-2 mb-2">
            Address :<span className="pl-40 text-[#7D7D7D]"> Chennai </span>
          </h1>
          <h1 className="flex  mb-2">
            City :<span className="pl-48 text-[#7D7D7D]"> Chennai </span>
          </h1>
          <h1 className="flex gap-3 mb-2">
            State :<span className="pl-44 text-[#7D7D7D]">Tamilnadu</span>
          </h1>
          <h1 className="flex   mb-2">
            Note :<span className="pl-48 text-[#7D7D7D]"> Test </span>
          </h1>
        </div>
      </div>
    </div>
